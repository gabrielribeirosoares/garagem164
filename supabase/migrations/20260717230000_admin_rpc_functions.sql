-- =============================================================
-- SCRIPT COMPLETO: Execute este script NO SEU SUPABASE SQL EDITOR
-- Ele cria todas as funções necessárias para o painel admin.
-- =============================================================

-- 1. Função RPC: Retorna a lista de clientes da loja com dados de perfil
...
-- 2. Função RPC: Vincula um cliente existente por e-mail à loja
